...
mdata = ["PT. XYZ Komputer",
        ...
        " Kota Parepare",
        "Najwa Sitakka",
        "e-Mail: najwasitakka@ith.ac.id",
        "Juaa",
        "27 Februari 2005"]

djual = [["B3301","B3302","B3303","B3304","B3305"],
        ["Laptop","Mouse","Printer","Webcam","Proyektor"],
        [15,5,50,3,10],
        [3,3,3,3,3]]
...
print("-"*77)
print("1. "+"|"+djual[0][0].center(13)+"|"+djual[1][0].center(19)+"|"+f"Rp{djual[2][0]*r},-".rjust(15)+"|"+"3".center(8)+"|"+f"Rp{3*r*djual[2][0]}".center(14)+'|')
print("2. "+"|"+djual[0][1].center(13)+"|"+djual[1][1].center(19)+"|"+f"Rp{djual[2][1]*r},-".rjust(15)+"|"+"3".center(8)+"|"+f"Rp{3*r*djual[2][1]}".center(14)+'|')
print("3. "+"|"+djual[0][2].center(13)+"|"+djual[1][2].center(19)+"|"+f"Rp{djual[2][2]*r},-".rjust(15)+"|"+"3".center(8)+"|"+f"Rp{3*r*djual[2][2]}".center(14)+'|')
print("4. "+"|"+djual[0][3].center(13)+"|"+djual[1][3].center(19)+"|"+f"Rp{djual[2][3]*r},-".rjust(15)+"|"+"3".center(8)+"|"+f"Rp{3*r*djual[2][3]}".center(14)+'|')
print("5. "+"|"+djual[0][4].center(13)+"|"+djual[1][4].center(19)+"|"+f"Rp{djual[2][4]*r},-".rjust(15)+"|"+"3".center(8)+"|"+f"Rp{3*r*djual[2][4]}".center(14)+'|')
print("-"*77)
